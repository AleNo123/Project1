...
data_array = loadmat('data/record_data_13.mat')
...
chunk_arr = chunk_arr.reshape(chunk_arr.shape[0], 740, 14)
...
chunk_arr1 = chunk_arr1.reshape(chunk_arr1.shape[0], 740, 14)
